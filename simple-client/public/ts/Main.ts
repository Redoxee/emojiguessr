...
let emojiPicker : HTMLElement = document.querySelector('emoji-picker')!; 
...
function setVisibility(element : HTMLElement, display : boolean) {
...
interface EmojiPickerEvent extends Event {
	unicode : string
}

emojiPicker.addEventListener('emoji-click' , (event)=>{
	const cevent = event as CustomEvent<EmojiPickerEvent>;
